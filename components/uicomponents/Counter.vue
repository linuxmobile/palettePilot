...
const calculateTimeSinceLaunch = () => {
  ...
  const totalHours = Math.floor(differenceInTime / (1000 * 60 * 60))
    .toString()
    .padStart(2, '0')
...
<template>
  <div
    class="rounded-xl flex flex-col px-8 py-5 gap-y-2 relative"
    :style="{ backgroundColor: bg, color: fg }"
  >
    <h4 class="text-3xl font-bold text-pretty">
      Time elapsed since deployment
    </h4>
    <div class="grid grid-cols-5 text-center">
      <div class="">
        <p class="text-6xl font-black">
          {{ String(timeSinceLaunch.totalHours).padStart(2, '0') }}
        </p>
      ...
      <div class="">
        <p class="text-6xl font-black">
          {{ String(timeSinceLaunch.minutes).padStart(2, '0') }}
        </p>
      ...
      <div class="">
        <p class="text-6xl font-black">
          {{ String(timeSinceLaunch.seconds).padStart(2, '0') }}
        </p>
