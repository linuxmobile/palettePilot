...
<template>
  ...
  >
    <template #container="{ closeCallback }">
      ...
      >
        <header class="w-full border-b border-gray-500 font-semibold text-lg">
          Export Code
        </header>
        <div
        ...
        <button
          @click="closeCallback"
          class="p-3 w-full text-primary-50 border-1 border-white/30 rounded-md bg-gray-200 hover:bg-gray-300 dark:bg-neutral-800 dark:border-neutral-700 hover:dark:bg-neutral-700"
        >
          Cancel
        </button>
      </section>
